...
export interface BaseProcessingOptions {
     ...
     */
    filter_blocks?: Array<'Header' | 'Footer' | 'Title' | 'Section Header' | 'Page Number' | 'List Item' | 'Figure' | 'Table' | 'Key Value' | 'Text' | 'Comment' | 'Signature'>;
    /**
    ...
    namespace FullResult {
        ...
        namespace Chunk {
            interface Block {
                 ...
                 */
                type: 'Header' | 'Footer' | 'Title' | 'Section Header' | 'Page Number' | 'List Item' | 'Figure' | 'Table' | 'Key Value' | 'Text' | 'Comment' | 'Signature';
                /**
...
export declare namespace PipelineResponse {
    interface Result {
...
export declare namespace SplitResponse {
    /**
     * The split result.
     */
    interface Result {
