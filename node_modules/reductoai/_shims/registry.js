...
function setShims(shims, options = { auto: false }) {
    if (exports.auto) {
        throw new Error(`you must \`import 'reductoai/shims/${shims.kind}'\` before importing anything else from reductoai`);
    }
    if (exports.kind) {
        throw new Error(`can't \`import 'reductoai/shims/${shims.kind}'\` after \`import 'reductoai/shims/${exports.kind}'\``);
    }
